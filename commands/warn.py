...
def register(app):
    app.add_handler(MessageHandler(filters.COMMAND & filters.Regex(r'^!выговор\b'), cmd_warn))
    app.add_handler(MessageHandler(filters.COMMAND & filters.Regex(r'^!лист\b'), cmd_warn_list))
    app.add_handler(MessageHandler(filters.COMMAND & filters.Regex(r'^!снять выговор\b'), cmd_remove_warn))